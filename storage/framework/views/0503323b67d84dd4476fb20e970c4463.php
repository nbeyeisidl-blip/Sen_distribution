    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3">
            <div class="card border-0 shadow-sm p-3">
                ...
                <h3 class="fw-bold text-primary mb-0 mt-2"><?php echo e($totalProducts ?? 0); ?></h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm p-3">
                <span class="text-muted small fw-semibold">Stock Total</span>
                <h3 class="fw-bold text-success mb-0 mt-2"><?php echo e($totalStock ?? 0); ?></h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm p-3">
                <span class="text-muted small fw-semibold">Ruptures / Alertes</span>
                <h3 class="fw-bold text-warning mb-0 mt-2"><?php echo e($lowStockCount ?? 0); ?></h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="card border-0 shadow-sm p-3">
                <span class="text-muted small fw-semibold">Entrées du mois</span>
                <h3 class="fw-bold text-info mb-0 mt-2"><?php echo e($monthlyEntries ?? 0); ?></h3>
            </div>
        </div>
    </div>
