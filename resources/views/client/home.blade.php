...
{{-- Ajustez le nom de votre layout si besoin --}}

@section('content')
<div class="container py-4">

    {{-- 1. SECTION HERO BANNIÈRE --}}
    ...
    {{-- 2. ENGAGEMENTS & SERVICES (4 Piliers) --}}
    ...
    {{-- 3. SECTION PRINCIPALE : CATALGOUE ET FILTRES --}}
    <div class="row pt-3" id="catalogue">
        ...
        <div class="col-lg-3 mb-4">
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="list-group list-group-flush">
                    <a href="{{ route('client.home') }}" class="list-group-item list-group-item-action {{ !request('category_id') ? 'active fw-bold' : '' }}">
                        Tous nos produits
                    </a>
                    @foreach($categories as $category)
                        <a href="{{ route('client.home', ['category_id' => $category->id]) }}" 
        ...
        <div class="col-lg-9">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="text-muted small">{{ $products->count() }} produit(s) disponible(s)</span>
            </div>
                    ...
                    <div class="col">
                        <div class="card h-100 border-0 shadow-sm position-relative product-card">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div>
                                    <span class="badge bg-light text-dark border mb-2">{{ $product->category->name ?? 'Général' }}</span>
                                    <h5 class="card-title fw-bold h6 text-truncate mb-2">{{ $product->name }}</h5>
